...
#Assignment
# Q. Write a function for a k fold cross validation.What's the dataset name? What's the equation of the model? Whether it's a linear regression model or a logistic regression problem
